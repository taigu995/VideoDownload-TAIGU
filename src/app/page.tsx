    ...
    <div className="h-screen flex flex-col bg-slate-950 text-white overflow-hidden">
      ...
      <div className="flex items-center bg-slate-900/80 border-b border-white/5">
        ...
        <div className="flex items-center gap-1 px-2">
          ...
          <a
            href="/api/package"
            className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium bg-gradient-to-r from-violet-600 to-cyan-500 text-white hover:from-violet-500 hover:to-cyan-400 transition-all shadow-lg shadow-violet-500/20"
            title="下载完整项目压缩包，在Win10上一键打包成EXE"
          >
